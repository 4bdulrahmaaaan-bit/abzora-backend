...
function run() {
  const originalSigningSecret = process.env.INVOICE_SIGNING_SECRET;
  process.env.INVOICE_SIGNING_SECRET = 'invoice-hardening-smoke-secret';
  try {
    ...
    process.env.INVOICE_SIGNING_SECRET = originalSigningSecret;
  }
}
